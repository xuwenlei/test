		...
		<div class="container">
			...
			<div style="margin-right: 130px;">
				...
				<div
					...
					<a href="javascript:;" onclick="clearCart()" class="clear">清空购物车</a> 
					<a href="${pageContext.request.contextPath }/product?method=submitOrder"> 
						<input type="button" width="100" value="提交订单" name="submit" style="background: url('./images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0); height: 35px; width: 100px; color: white;">
					</a>
				</div>
			</div>
