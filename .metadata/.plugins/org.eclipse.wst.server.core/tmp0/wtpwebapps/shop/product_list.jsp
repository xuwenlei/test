...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		<div class="col-md-12">
			<ol class="breadcrumb">
				<!-- <li><a href="#">首页</a></li> -->
				<a href="${pageContext.request.contextPath }">首页&nbsp;&nbsp;&gt;</a> <a href="javascript:;">${category.cname }</a>
			</ol>
		</div>
		...
		<c:forEach items="${pageBean.list }" var="product">
			<div class="col-md-2"  style="height: 250px">
				...
				<p style="margin: 5px 1px -2px">
					<a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${product.pid}&cid=${cid}&currentPage=${pageBean.currentPage}" style='color: black'>${product.pname}</a>
				</p>
				<p>
	...
	<div
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
				<c:forEach items="${historyProductList }" var="hisPro">
					<li style="width: 150px; height: 216; float: left; margin: 0 8px 0 0; padding: 0 18px 15px; text-align: center;">
						<a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${hisPro.pid}">
							<img src="${hisPro.pimage }" width="130px" height="130px" />
						</a>
					</li>
				</c:forEach>
			</ul>
