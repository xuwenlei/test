			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<div>
							<c:if test="${cid==null }">
								<a href="${pageContext.request.contextPath}">返回浏览列表</a>
							</c:if>
							<c:if test="${cid!=null }">
								<a href="${pageContext.request.contextPath}/product?method=productListByCid&cid=${cid}&currentPage=${currentPage}">返回浏览列表</a>
							</c:if>
						</div>
					</div>
				</div>
