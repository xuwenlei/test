			...
			<div class="container-fluid" style="width: 85%">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotProduct">
						...
						<a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${hotProduct.pid}">
							<img src="${pageContext.request.contextPath }/${hotProduct.pimage }" width="130" height="130" style="display: inline-block;">
						</a>
						<p style="margin: 5px 1px -2px"><a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${hotProduct.pid}" style='color:black;font-size: 13px'>${hotProduct.pname }</a></p>
